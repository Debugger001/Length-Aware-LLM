...
CKPT_PATH=/data/cliu/checkpoints/Length-LLM/deepscale_1.5b_deepscaler_1000_0725/global_step_250
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=deepscale_1.5b_deepscaler_1000_0725_contd \
