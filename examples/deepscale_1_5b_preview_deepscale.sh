...
CKPT_PATH=/home/cliu/Length-Aware-LLM/checkpoints/Length-LLM/deepscale_1.5b_deepscaler_1000_0725/global_step_250
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=deepscale_1.5b_deepscaler_1000_0727 \
