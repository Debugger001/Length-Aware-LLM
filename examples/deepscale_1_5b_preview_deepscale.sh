...
CKPT_PATH=/data/cliu/Length-Aware-LLM/checkpoints/Length-LLM/deepscale_1.5b_deepscaler_2500_0802/global_step_200
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=deepscale_1.5b_deepscaler_2500_0826 \
    trainer.project_name=Length-LLM \
    trainer.n_gpus_per_node=4 \
    trainer.save_freq=25 \
    algorithm.penalty_cap=0.4 \
    algorithm.lambda_len_init=0.00001 \
    algorithm.dual_lr=0.001 \
