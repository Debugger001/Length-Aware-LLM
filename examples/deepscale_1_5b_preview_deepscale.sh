...
CKPT_PATH=/data/cliu/checkpoints/Length-LLM/deepscale_1.5b_deepscaler_grpo_base/global_step_100/
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=deepscale_1.5b_deepscaler_grpo_base_0804 \
